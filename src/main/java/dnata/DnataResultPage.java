...
public class DnataResultPage {
	public static void ResultPageForFlight(String TravellerType, String TripType, String adult, String child,
			...
			String QuoteRemark, String AdultName, String ChildTitle, String ChildName, String ChildDOBdate,
			String ChildGender, String ChildDocType, String ChildPassportNumber, String ChildPassportDate,
			String InfantTitle, String InfantName, String InfantDOBdate, String InfantGender,
...
//			}
			...
			if (TravellerType.equalsIgnoreCase("Individual")) {
				...
				DnataCheckoutPage.CheckoutForFlightMultiplePassengers(TravellerType, TripType, adult, child, infant,
						ModifySearch, ChangeTravellers, adultM, childM, infantM, Resultpagestep, QuoteTitle,
						QuoteRemark, AdultName, ChildTitle, ChildName, ChildDOBdate, ChildGender, ChildDocType,
						ChildPassportNumber, ChildPassportDate, InfantTitle, InfantName, InfantDOBdate, InfantGender,
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Clicked on Book Now</i></b>");
	...
	public static void ResultPageForHotel(String TravellerType, String CheckInDate, String Rooms, String Adult,
			String Child, String ChildAge, String Supplier, String ModifySearch, String ChangeTripLocation,
			String CityCodeM, String CityTitleM, String ChangeTripDate, String CheckInDateM, String CheckOutDateM,
			String ChangeRooms, String RoomsM, String AdultM, String ChildM, String ChildAgeM, String ChangeStarRating,
			String StarRatingM, String SupplierChange, String MSupplier, String Resultpagestep, String QuoteTitle,
			String QuoteRemark, String AdultName, String ChildTitle, String ChildName, String ChildAgeMul,
			String ChildDOBdate, String ChildGender, String Checkoutpagestep) throws Exception {
		Thread.sleep(30000);
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Final Book Button</i></b>");
				...
				DnataCheckoutPage.individualforHotel(TravellerType, CheckInDate, Adult, Child, ChildAge, ModifySearch,
						ChangeRooms, AdultM, ChildM, Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle,
						ChildName, ChildAgeMul, ChildDOBdate, ChildGender, Checkoutpagestep);
			}
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on Final Book Button</i></b>");
			...
			if (TravellerType.equalsIgnoreCase("Individual")) {
				DnataCheckoutPage.individualforInsurance(TravellerType, SelectPax, PaxDOB, ModifySearch, SelectPaxM,
						PaxDOBM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep);
			} else if (TravellerType.equalsIgnoreCase("Dependent")) {
				DnataCheckoutPage.CheckoutForInsuranceDependent(TravellerType, SelectPax, PaxDOB, ModifySearch,
						SelectPaxM, PaxDOBM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep);
			}
