...
public class DnataFlight {
	...
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("dnataFlight", "Multi");
	}
	...
	public static void dnataforflight(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			...
			String AirLine, String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultName,
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataResultPage.ResultPageForFlight(TravellerType, TripType, adult, child, infant, Supplier,
						...
						QuoteTitle, QuoteRemark, AdultName, ChildTitle, ChildName, ChildDOBdate, ChildGender,
						ChildDocType, ChildPassportNumber, ChildPassportDate, InfantTitle, InfantName, InfantDOBdate,
						InfantGender, InfantTravellingwith, InfantDocType, InfantPassportNumber, InfantPassportDate,
						Checkoutpagestep);
