...
public class DnataCheckoutPage {
	public static void individualforFlight(String TravellerType, String TripType, String adult, String child,
			...
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultName, String ChildTitle,
			String ChildName, String ChildDOBdate, String ChildGender, String ChildDocType, String ChildPassportNumber,
			String ChildPassportDate, String InfantTitle, String InfantName, String InfantDOBdate, String InfantGender,
			String InfantTravellingwith, String InfantDocType, String InfantPassportNumber, String InfantPassportDate,
			String Checkoutpagestep) throws Exception {
...
//			QaRobot.PassValue("ArrangerEmail","Test"); 
			...
			bookForFlight(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers, adultM, childM,
					infantM, QuoteTitle, QuoteRemark, Checkoutpagestep);
			...
			CheckoutForFlightDependent(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers,
					adultM, childM, infantM, Resultpagestep, QuoteTitle, QuoteRemark, Checkoutpagestep);
		} else if (TravellerType.equalsIgnoreCase("MultiplePassengers")) {
			CheckoutForFlightMultiplePassengers(TravellerType, TripType, adult, child, infant, ModifySearch,
					ChangeTravellers, adultM, childM, infantM, Resultpagestep, QuoteTitle, QuoteRemark, AdultName,
					ChildTitle, ChildName, ChildDOBdate, ChildGender, ChildDocType, ChildPassportNumber,
					ChildPassportDate, InfantTitle, InfantName, InfantDOBdate, InfantGender, InfantTravellingwith,
					InfantDocType, InfantPassportNumber, InfantPassportDate, Checkoutpagestep);
		}
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup Close</i></b>");
		...
		bookForFlightDependent(TravellerType, TripType, adult, child, infant, ModifySearch, ChangeTravellers, adultM,
				childM, infantM, QuoteTitle, QuoteRemark, Checkoutpagestep);
	}

	public static void CheckoutForFlightMultiplePassengers(String TravellerType, String TripType, String adult,
			String child, String infant, String ModifySearch, String ChangeTravellers, String adultM, String childM,
			String infantM, String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultName,
			String ChildTitle, String ChildName, String ChildDOBdate, String ChildGender, String ChildDocType,
			String ChildPassportNumber, String ChildPassportDate, String InfantTitle, String InfantName,
			String InfantDOBdate, String InfantGender, String InfantTravellingwith, String InfantDocType,
			String InfantPassportNumber, String InfantPassportDate, String Checkoutpagestep) throws Exception {
		String ParentWindow = QaBrowser.driver.getWindowHandle();
		QaRobot.ClickOnElement("dept_AssociatePax");
		Thread.sleep(3000);
		Set<String> handles = QaBrowser.driver.getWindowHandles();
		...
		Thread.sleep(1000);
		MultiPassengerAdultCheckoutForFlight(adult, AdultName);
		QaBrowser.driver.switchTo().window(ParentWindow);
		QaRobot.switchframe("//frame[@name='login']");
		QaRobot.switchframe("//frame[@name='main']");
		if (Resultpagestep.equalsIgnoreCase("Add to Cart")) {
		...
		MultiPassengerChildCheckoutForFlight(child, ChildTitle, ChildName, ChildDOBdate, ChildGender, ChildDocType,
				ChildPassportNumber, ChildPassportDate);
		MultiPassengerInfantCheckoutForFlight(infant, InfantTitle, InfantName, InfantDOBdate, InfantGender,
				InfantTravellingwith, InfantDocType, InfantPassportNumber, InfantPassportDate);
		QaExtentReport.extentScreenshot("Checkout Page");
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup Close</i></b>");
	...
	public static void CheckoutForHotelDependent(String CheckInDate, String Adult, String Child, String ChildAge,
			String ModifySearch, String ChangeRooms, String AdultM, String ChildM, String Resultpagestep,
			String QuoteTitle, String QuoteRemark, String AdultName, String ChildTitle, String ChildName,
			String ChildAgeMul, String ChildDOBdate, String ChildGender, String Checkoutpagestep) throws Exception {
		String ParentWindow = QaBrowser.driver.getWindowHandle();
...
//			QaExtentReport.test.log(Status.INFO, "<b><i>Click on Fare Breakup Close</i></b>");
			...
			bookForHotelDependent(CheckInDate, Adult, Child, ChildAge, ModifySearch, ChangeRooms, AdultM, ChildM,
					Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle, ChildName, ChildAgeMul,
					ChildDOBdate, ChildGender, Checkoutpagestep);
		}
	}

	public static void CheckoutForHotelMultiplePassengers(String CheckInDate, String Adult, String Child,
			String ChildAge, String ModifySearch, String ChangeRooms, String AdultM, String ChildM,
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultName, String ChildTitle,
			String ChildName, String ChildAgeMul, String ChildDOBdate, String ChildGender, String Checkoutpagestep)
			throws Exception {
		String ParentWindow = QaBrowser.driver.getWindowHandle();
//		if (QaBrowser.driver.findElement(By.xpath(
//				"//div/span/span[contains(text(),'The hotel you have selected is no more available now!!  Kindly try another hotel room.')]"))
...
//		} else {
		...
		Thread.sleep(1000);
		MultiPassengerAdultCheckoutForHotel(Adult, AdultName);
		QaBrowser.driver.switchTo().window(ParentWindow);
		QaRobot.switchframe("//frame[@name='login']");
		QaRobot.switchframe("//frame[@name='main']");
		if (Resultpagestep.equalsIgnoreCase("Add to Cart")) {
		...
		MultiPassengerChildCheckoutForHotel(CheckInDate, Child, ChildAge, ChildTitle, ChildName, ChildAgeMul,
				ChildDOBdate, ChildGender);
		QaExtentReport.extentScreenshot("Checkout Page");
		JavascriptExecutor mo = (JavascriptExecutor) QaBrowser.driver;
		mo.executeScript("window.scrollBy(0,400)", "");
		Thread.sleep(2000);
...
//		QaRobot.ClickOnElement("TermsAndConditionF");
		bookForHotelDependent(CheckInDate, Adult, Child, ChildAge, ModifySearch, ChangeRooms, AdultM, ChildM,
				Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle, ChildName, ChildAgeMul, ChildDOBdate,
				ChildGender, Checkoutpagestep);
//		}
	}
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on BookAndQuote Button</i></b>");
			...
			DnataConfirmPage.confirmpageFlightwithBookingQueue(TravellerType, adult, child, infant, ModifySearch,
					ChangeTravellers, adultM, childM, infantM);
		} else if (Checkoutpagestep.equalsIgnoreCase("Fulfilment")) {
			QaRobot.PassValue("DestinationPhoeF", "9863647257");
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void individualforHotel(String TravellerType, String CheckInDate, String Adult, String Child,
			String ChildAge, String ModifySearch, String ChangeRooms, String AdultM, String ChildM,
			String Resultpagestep, String QuoteTitle, String QuoteRemark, String AdultName, String ChildTitle,
			String ChildName, String ChildAgeMul, String ChildDOBdate, String ChildGender, String Checkoutpagestep)
			throws Exception {
...
//			QaRobot.PassValue("ArrangerEmail", "Test");
			...
			CheckoutForHotelDependent(CheckInDate, Adult, Child, ChildAge, ModifySearch, ChangeRooms, AdultM, ChildM,
					Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle, ChildName, ChildAgeMul,
					ChildDOBdate, ChildGender, Checkoutpagestep);
		} else if (TravellerType.equalsIgnoreCase("MultiplePassengers")) {
			CheckoutForHotelMultiplePassengers(CheckInDate, Adult, Child, ChildAge, ModifySearch, ChangeRooms, AdultM,
					ChildM, Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle, ChildName, ChildAgeMul,
					ChildDOBdate, ChildGender, Checkoutpagestep);
		}
	}
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void bookForHotelDependent(String CheckInDate, String Adult, String Child, String ChildAge,
			String ModifySearch, String ChangeRooms, String AdultM, String ChildM, String Resultpagestep,
			String QuoteTitle, String QuoteRemark, String AdultName, String ChildTitle, String ChildName,
			String ChildAgeMul, String ChildDOBdate, String ChildGender, String Checkoutpagestep) throws Exception {
		if (Checkoutpagestep.equalsIgnoreCase("Quote")) {
...
//			QaExtentReport.test.log(Status.INFO,"<b><i>Clicked on FulfilmentF Button</i></b>");
	...
	public static void individualforInsurance(String TravellerType, String SelectPax, String PaxDOB,
			...
			String QuoteRemark, String Checkoutpagestep) throws Exception {
		if (TravellerType.equalsIgnoreCase("Individual")) {
			Thread.sleep(7000);
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
		...
		bookForInsuranceDependent(TravellerType, QuoteTitle, QuoteRemark, Checkoutpagestep);
...
//		}
	...
	public static void MultiPassengerAdultCheckoutForFlight(String adult, String AdultName) throws Exception {
		int adt = Integer.parseInt(adult);
		for (int i = 1; i <= adt; i++) {
			String NameSelection[] = AdultName.split(",");
			String NameS = NameSelection[i - 1];
			QaRobot.PassValue("dept_AssociatePaxFirstName", NameS);
			QaRobot.ClickOnElement("dept_AssociatePaxSelect");
			Thread.sleep(3000);
			QaRobot.ClickOnElement("dept_AssociatePaxSelectPassenger");
			QaRobot.ClickOnElement("dept_AddToList");
		}
		for (int i = 1; i <= adt; i++) {
			WebElement webelement = QaBrowser.driver.findElement(
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
	...
	public static void MultiPassengerChildCheckoutForFlight(String child, String ChildTitle, String ChildName,
			String ChildDOBdate, String ChildGender, String ChildDocType, String ChildPassportNumber,
			String ChildPassportDate) throws Exception {
		int chd = Integer.parseInt(child);
		for (int i = 1; i <= chd; i++) {
			// select title
			...
			String childNameElement = "//input[@id='txt_firstNameChd" + i + "']";
			QaRobot.PassValueByLocator(childNameElement, Fcname, "<b><i>Entered First Name For child</i></b>");
			Thread.sleep(2000);
			...
			if (date.isBefore(today.minusYears(2)) && date.isAfter(today.minusYears(12))) {
				String text3 = "(//select[@id='ctl00_contentMain_txt_birthDateChd_ddlDay'])[" + i + "]";
				QaRobot.selectTextByLocator1(text3, Date1, "<b><i>Select Passport Date for child</i></b>");
				Thread.sleep(2000);

				String text4 = "(//select[@id='ctl00_contentMain_txt_birthDateChd_ddlMonth'])[" + i + "]";
				QaRobot.selectTextByLocator1(text4, Month1, "<b><i>Select Passport month for child</i></b>");
				Thread.sleep(2000);

				String text5 = "(//select[@id='ctl00_contentMain_txt_birthDateChd_ddlYear'])[" + i + "]";
				QaRobot.selectTextByLocator1(text5, Year1, "<b><i>Select Passport year for child</i></b>");
				Thread.sleep(2000);
			} else {
				QaExtentReport.test.log(Status.FAIL,
						"<b><i>Invalid Child Date Selection</i></b>" + " - " + Date1 + "-" + Month1 + "-" + Year1);
			...
			String gender = "(//select[@id='ctl00_contentMain_ddl_genderChd'])[" + i + "]";
			String ChildG[] = ChildGender.split(",");
			QaRobot.selectTextByLocator1(gender, ChildG[i - 1], "<b><i>Select gender for child</i></b>");
			Thread.sleep(2000);

			String DocType = "(//select[@id='ctl00_contentMain_ddlDocumentTypechd'])[" + i + "]";
			QaRobot.selectTextByLocator1(DocType, ChildDocType, "<b><i>Select Doc Tyep for child</i></b>");
			Thread.sleep(2000);

//			String DocNumber = "//input[@id='txt_passportChd" + i + "']";
			String ChildPN[] = ChildPassportNumber.split(",");
			QaBrowser.driver.findElement(By.xpath("//input[@id='txt_passportChd" + i + "']")).sendKeys(ChildPN[i - 1]);
//			QaRobot.PassValue(DocNumber, ChildPN[i - 1]);
//			QaRobot.selectTextByLocator1(DocNumber, ChildPN[i - 1], "<b><i>Select Doc Number for child</i></b>");
			Thread.sleep(2000);
			...
			String text = "(//select[@id='ctl00_contentMain_txt_ex_dateChd_ddlDay'])[" + i + "]";
			QaRobot.selectTextByLocator1(text, Date, "<b><i>Select Passport Date for child</i></b>");
			Thread.sleep(2000);

			String text1 = "(//select[@id='ctl00_contentMain_txt_ex_dateChd_ddlMonth'])[" + i + "]";
			QaRobot.selectTextByLocator1(text1, Month, "<b><i>Select Passport month for child</i></b>");
			Thread.sleep(2000);

			String text2 = "(//select[@id='ctl00_contentMain_txt_ex_dateChd_ddlYear'])[" + i + "]";
			QaRobot.selectTextByLocator1(text2, Year, "<b><i>Select Passport year for child</i></b>");
			Thread.sleep(2000);
		}
//		QaRobot.ScreenshotMethod("ChildDetails", "<b><i>Screenshot for Child Details</i></b>");
		QaExtentReport.extentScreenshot("Child Details");
	...
	public static void MultiPassengerInfantCheckoutForFlight(String infant, String InfantTitle, String InfantName,
			String InfantDOBdate, String InfantGender, String InfantTravellingwith, String InfantDocType,
			String InfantPassportNumber, String InfantPassportDate) throws Exception {
		int ift = Integer.parseInt(infant);
		for (int i = 1; i <= ift; i++) {
			String childTitleElement = "(//select[@id='ctl00_contentMain_ddl_titleInf'])[" + i + "]";
			String[] childtitle = InfantTitle.split(",");
			QaRobot.selectTextByLocator1(childTitleElement, childtitle[i - 1], "<b><i>Select title for infant</i></b>");
			Thread.sleep(2000);
			...
			if (date.isAfter(today.minusYears(2))) {
				String text3 = "(//select[@id='ctl00_contentMain_txt_birthDateInf_ddlDay'])[" + i + "]";
				QaRobot.selectTextByLocator1(text3, Date, "<b><i>Select Passport Date for Infant</i></b>");
				Thread.sleep(2000);

				String text4 = "(//select[@id='ctl00_contentMain_txt_birthDateInf_ddlMonth'])[" + i + "]";
				QaRobot.selectTextByLocator1(text4, Month, "<b><i>Select Passport month for Infant</i></b>");
				Thread.sleep(2000);

				String text5 = "(//select[@id='ctl00_contentMain_txt_birthDateInf_ddlYear'])[" + i + "]";
				QaRobot.selectTextByLocator1(text5, Year, "<b><i>Select Passport year for Infant</i></b>");
				Thread.sleep(2000);
			} else {
				QaExtentReport.test.log(Status.FAIL,
						"<b><i>Invalid Infant Date Selection</i></b>" + " - " + Date + "-" + Month + "-" + Year);
			...
			String gender = "(//select[@id='ctl00_contentMain_ddl_genderInf'])[" + i + "]";
			String InfantG[] = InfantGender.split(",");
			QaRobot.selectTextByLocator1(gender, InfantG[i - 1], "<b><i>Select gender for child</i></b>");
			Thread.sleep(2000);

			String InTravellingwith = "(//select[@id='ctl00_contentMain_ddl_travell_with'])[" + i + "]";
			String InfantTW[] = InfantTravellingwith.split(",");
			QaRobot.selectTextByLocator1(InTravellingwith, InfantTW[i - 1], "<b><i>Select gender for child</i></b>");
			Thread.sleep(2000);

			String DocType = "(//select[@id='ctl00_contentMain_ddlDocumentTypeinf'])[" + i + "]";
			QaRobot.selectTextByLocator1(DocType, InfantDocType, "<b><i>Select Doc Tyep for child</i></b>");
			Thread.sleep(2000);

//			String DocNumber = "//input[@id='txt_passportInf" + i + "']";
			String InfantPN[] = InfantPassportNumber.split(",");
			QaBrowser.driver.findElement(By.xpath("//input[@id='txt_passportInf" + i + "']")).sendKeys(InfantPN[i - 1]);
//			QaRobot.PassValue(DocNumber, InfantPN[i - 1]);
//			QaRobot.selectTextByLocator1(DocNumber, InfantPN[i - 1], "<b><i>Select Doc Number for child</i></b>");
			Thread.sleep(2000);
			...
			String text = "(//select[@id='ctl00_contentMain_txt_ex_dateInf_ddlDay'])[" + i + "]";
			QaRobot.selectTextByLocator1(text, Date1, "<b><i>Select Passport Date for child</i></b>");
			Thread.sleep(2000);

			String text1 = "(//select[@id='ctl00_contentMain_txt_ex_dateInf_ddlMonth'])[" + i + "]";
			QaRobot.selectTextByLocator1(text1, Month1, "<b><i>Select Passport month for child</i></b>");
			Thread.sleep(2000);

			String text2 = "(//select[@id='ctl00_contentMain_txt_ex_dateInf_ddlYear'])[" + i + "]";
			QaRobot.selectTextByLocator1(text2, Year1, "<b><i>Select Passport year for child</i></b>");
			Thread.sleep(2000);
		}
//		QaRobot.ScreenshotMethod("InfantDetails", "<b><i>Screenshot for Infant Details</i></b>");
		QaExtentReport.extentScreenshot("Infant Details");
...
//		QaRobot.ScreenshotMethod("ChildDetails", "<b><i>Screenshot for Child Details</i></b>");
	...
	public static void MultiPassengerAdultCheckoutForHotel(String adult, String AdultName) throws Exception {
		String[] adt = adult.split(",");
		int adtTotal = 0;
		for (int j = 0; j < adt.length; j++) {
			adtTotal = Integer.parseInt(adt[j]) + adtTotal;
...
//		QaExtentReport.test.log(Status.INFO, "<b><i>clicked on Associate button</i></b>");
	...
	public static void MultiPassengerChildCheckoutForHotel(String CheckInDate, String Child, String ChildAge,
			String ChildTitle, String ChildName, String ChildAgeMul, String ChildDOBdate, String ChildGender)
			throws Exception {
		String[] chd = Child.split(",");
		int chdTotal = 0;
		for (int j = 0; j < chd.length; j++) {
		...
		for (int i = 1; i <= chdTotal; i++) {
			...
			if (date.isAfter(bDate.minusYears(17))) {
				if (date.isAfter(bDate.minusYears(ag2)) && date.isBefore(bDate.minusYears(ag1))) {
					String text3 = "(//select[@id='ctl00_contentMain_txt_DobChd_H_ddlDay'])[" + i + "]";
					QaRobot.selectTextByLocator1(text3, Dcname, "<b><i>Select Passport Date for child</i></b>");
					Thread.sleep(2000);

					String text4 = "(//select[@id='ctl00_contentMain_txt_DobChd_H_ddlMonth'])[" + i + "]";
					QaRobot.selectTextByLocator1(text4, Mcname, "<b><i>Select Passport month for child</i></b>");
					Thread.sleep(2000);

					String text5 = "(//select[@id='ctl00_contentMain_txt_DobChd_H_ddlYear'])[" + i + "]";
					QaRobot.selectTextByLocator1(text5, Ycname, "<b><i>Select Passport year for child</i></b>");
					Thread.sleep(2000);
				} else {
					QaExtentReport.test.log(Status.FAIL, "<b><i>Invalid Child Date Selection</i></b>" + " - " + Dcname
							+ "-" + Mcname + "-" + Ycname);
			...
			String gender = "(//select[@id='ctl00_contentMain_ddl_genderChd_H'])[" + i + "]";
			String ChildG[] = ChildGender.split(",");
			QaRobot.selectTextByLocator1(gender, ChildG[i - 1], "<b><i>Select gender for child</i></b>");
			Thread.sleep(2000);
		}
