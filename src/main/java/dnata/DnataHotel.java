...
public class DnataHotel {
	...
	public Object[][] getexceldata() throws Exception {
		return QaDataProvider.getTestdata("dnataHotel", "Sheet2");
	}
	...
	public static void dnataforhotel(String TestCaseId, String TestCaseType, String TestScenario, String Source,
			...
			String AdultName, String ChildTitle, String ChildName, String ChildAgeMul, String ChildDOBdate,
			String ChildGender, String Checkoutpagestep) throws Exception {
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataResultPage.ResultPageForHotel(TravellerType, CheckInDate, Rooms, Adult, Child, ChildAge, Supplier,
						ModifySearch, ChangeTripLocation, CityCodeM, CityTitleM, ChangeTripDate, CheckInDateM,
						CheckOutDateM, ChangeRooms, RoomsM, AdultM, ChildM, ChildAgeM, ChangeStarRating, StarRatingM,
						SupplierChange, MSupplier, Resultpagestep, QuoteTitle, QuoteRemark, AdultName, ChildTitle,
