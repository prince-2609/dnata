...
public class DnataInsurance 
{
	...
	{
		return QaDataProvider.getTestdata("dnataInsurance", "Sheet1");
	}
	
	@Test(dataProvider = "getexceldata")
	public static void dnataInsurance (String TestCaseId,String TestCaseType,String TestScenario,String Source,String URL,String CompanyCode,
			String UserName,String Password,String SearchCorporateTraveller,String TravelType,String TravellerType,String OriginCityCode,
			String OriginLocation,String DestinationCityCode,String DestinationLocation,String StartDate,String EndDate,String PolicyFor,String SelectPax,
			String PaxDOB,String FOPType,String ModifySearch,String ChangeTrip,String OriginCityCodeM,String OriginLocationM,String DestinationCityCodeM,
			String DestinationLocationM,String ChangeTripDate,String StartDateM,String EndDateM,String ChangePolicyFor,String PolicyForM,String SelectPaxM,String PaxDOBM,String ChangeFOPType,String FOPTypeM,String BenefitsNo,String Benefits,
...
//				QaExtentReport.test.log(Status.INFO,"<b><i>Select Policy</i></b>");
				...
				DnataTripType.InsuranceTriptype(TravellerType,OriginCityCode,OriginLocation,DestinationCityCode,DestinationLocation,
				StartDate,EndDate,PolicyFor,SelectPax,PaxDOB,FOPType);
				
				DnataResultPage.ResultPageForInsurance(TravellerType,SelectPax,PaxDOB,ModifySearch,ChangeTrip,OriginCityCodeM,OriginLocationM,
						DestinationCityCodeM,DestinationLocationM,ChangeTripDate,StartDateM,EndDateM,ChangePolicyFor,
						PolicyForM,SelectPaxM,PaxDOBM,ChangeFOPType,FOPTypeM,BenefitsNo,Benefits,Resultpagestep,
						QuoteTitle,QuoteRemark,Checkoutpagestep);
			}
